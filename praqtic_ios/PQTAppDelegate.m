...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if (!self.window.rootViewController) {
        ...
        PQTItemsViewController *itemsViewController = [[PQTItemsViewController alloc] init];
...
{
    BOOL success = [[PQTItemStore sharedStore] saveChanges];
    if (success) {
        NSLog(@"Saved all of the PQTItems");
    }
    else {
        NSLog(@"Could not save any of the PQTItems");
    }
}
